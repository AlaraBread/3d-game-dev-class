 ...
 */
typedef double GFC_Matrix4[4][4];
typedef double GFC_Matrix3[3][3];
typedef double GFC_Matrix2[2][2];

typedef float GFC_Matrix4F[4][4];
typedef float GFC_Matrix3F[3][3];
typedef float GFC_Matrix2F[2][2];
 ...
 */
Uint8 gfc_matrix2f_invert(GFC_Matrix4F out, GFC_Matrix4F in);
Uint8 gfc_matrix3f_invert(GFC_Matrix4F out, GFC_Matrix4F in);
Uint8 gfc_matrix4f_invert(GFC_Matrix4F out, GFC_Matrix4F in);
 ...
 */
void gfc_matrix3f_make_translation(GFC_Matrix3F out,GFC_Vector2DF move);
void gfc_matrix4f_make_translation(GFC_Matrix4F out,GFC_Vector3DF move);
...
#define gfc_matrix4f_slog(mat) _gfc_matrix4f_slog(__FILE__,__LINE__,mat)
#define gfc_matrix3f_slog(mat) _gfc_matrix3f_slog(__FILE__,__LINE__,mat)
#define gfc_matrix2f_slog(mat) _gfc_matrix2f_slog(__FILE__,__LINE__,mat)
...
void gfc_matrix4f_rotate_x(GFC_Matrix4F out,GFC_Matrix4F m,float theta);
void gfc_matrix4f_rotate_y(GFC_Matrix4F out,GFC_Matrix4F m,float theta);
void gfc_matrix4f_rotate_z(GFC_Matrix4F out,GFC_Matrix4F m,float theta);
 ...
 */
void gfc_matrix4f_rotate(GFC_Matrix4F out,GFC_Matrix4F in,float radians,GFC_Vector3DF axis);
...
void gfc_matrix4_rotate_x(GFC_Matrix4 out,GFC_Matrix4 m,double theta);
void gfc_matrix4_rotate_y(GFC_Matrix4 out,GFC_Matrix4 m,double theta);
void gfc_matrix4_rotate_z(GFC_Matrix4 out,GFC_Matrix4 m,double theta);
 ...
 * @param axis the axis about which to rotate
 */
void gfc_matrix4_rotate(GFC_Matrix4 out,GFC_Matrix4 in,double radians,GFC_Vector3D axis);
