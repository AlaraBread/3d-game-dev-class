...
static void level3(UIElement *button) { loadScene("assets/scenes/level3.gltf"); }
...
void mainMenu() {
	...
	createButton(gfc_vector2d(1280 / 2, 720 / 2 + 300), gfc_vector2d(300, 100), "boss level")->click = level3;
	gfc_line_cpy(label->text, "julia's super pool");
}
