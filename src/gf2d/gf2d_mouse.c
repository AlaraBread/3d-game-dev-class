...
int gf2d_mouse_hidden() { return (_mouse.hidden > 0); }

void gf2d_mouse_hide() { _mouse.hidden++; }

void gf2d_mouse_show() { _mouse.hidden--; }
...
GFC_Vector2D gf2d_mouse_get_position() { return _mouse.mouse[0].position; }
