...
/**
 * @brief Draw the mouse to the screen.  Should probably be the last thing you
 * do each frame
 */
 ...
 * @param button the button number to check (left mouse button is 0, right mouse
 * button is 1, etc)
 ...
 * @return a gfc_vector containing the mouse position information.  Position
 * will be -1,-1 if never updated
 */
...
/**
 * @brief get the ray (edge from a to b) generated by where the mouse is on the
 * screen into 3d space
 * @return an edge, where a is at the camera plane, and b extends beyond.  Use
 * it to ray trace against 3d world
 */
