 ...
 * {
	"actor":
	{
		...
		[
		{
			...
			"actionTime": 14 //how many frames this animation should
 take to complete one pass.  Overrides frameRate "type": "loop"  //"loop" or
 "pass" for an animation that loops or pass for a single pass through then stop
		}
		]
	}
	}
 ...
 * @note there may be more or less frames in the actual sprite, this just about
 ...
 * @param center (optional) if set it will use this point for scale and rotation
 * reference
