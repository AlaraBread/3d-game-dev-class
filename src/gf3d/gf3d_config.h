 ...
 * @return 0 on error or the VkDescriptorType, note zero is also a valid
 * response
 */
 ...
 * @return an empty VkDependencyFlags on error or configured VkSubpassDependency
 * otherwise
 */
 ...
 * @return VK_IMAGE_LAYOUT_UNDEFINED as default or the proper VK_IMAGE_LAYOUT_*
 * otherwise
 */
 ...
 * @param format provide this, as it may need to come from screen format,
 ...
 * @note strings need to math the case of the enumaration from Vulkan
 * specification
 * @url
