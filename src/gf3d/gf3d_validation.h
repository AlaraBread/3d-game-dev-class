 ...
 * @returns NULL if validation layers have not been initialized, or the address
 * of the first validation layer property
 */
VkLayerProperties *gf3d_validation_get_validation_layer_data();

/**
 * @brief get the number of validation layers that are available
 * @return 0 if there are none, or validation has not been initialized.  The
 * polled count otherwises
 */
