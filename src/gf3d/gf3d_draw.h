 ...
 * @param position where to move the sphere (final location is position +
 * edge.a.xyz
 * @param rotation how to rotation the edge about point a
 * @param scale how much to scale the scale.  The size of the edge is also a
 * factor
 ...
 * @param scale how much to scale the cube.  The size of the cube is also a
 * factor
 * @param color the color to draw with
 */
 ...
 * @param position where to draw the sphere.  final location is position +
 * sphere.xyz
 * @param rotation how to rotate the sphere (makes no sense unless there is
 * non-uniform scaling
