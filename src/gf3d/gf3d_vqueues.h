...
typedef enum { VQ_Graphics = 0, VQ_Present, VQ_Transfer, VQ_MAX } VQ_Types;
...
/**
 * @brief get graphics queue information needed to create a logical device based
 * on discovered queue properties
 * @param count a pointer to an integer to populate the count of create info
 * returned
