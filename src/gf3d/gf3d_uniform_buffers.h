 ...
 * his should be large enough to support the number of calls per frame you will
 * need
 * @param bufferFrames how many buffer frames to support.  This should match the
 * swap chain length
