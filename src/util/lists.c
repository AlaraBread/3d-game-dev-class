...
IntList *newIntList() {
	return (IntList *)gfc_list_new();
}

Vector3List *newVec3List() {
	return (Vector3List *)gfc_list_new();
}

TriangleList *newTriangleList() {
	return (TriangleList *)gfc_list_new();
}
...
int intListLength(IntList *list) {
	return gfc_list_get_count((GFC_List *)list);
}

int vec3ListLength(Vector3List *list) {
	return gfc_list_get_count((GFC_List *)list)/3;
}

int triangleListLength(Vector3List *list) {
	return gfc_list_get_count((GFC_List *)list)/9;
}
