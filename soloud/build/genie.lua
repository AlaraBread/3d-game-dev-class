...
local dxsdk_root = os.getenv("DXSDK_DIR") and os.getenv("DXSDK_DIR") or
...
files {"../src/audiosource/**.c*", "../src/filter/**.c*", "../src/core/**.c*"}

includedirs {"../src/**", "../include"}
if (WITH_OPENAL == 1) then
    defines {"WITH_OPENAL"}
    files {"../src/backend/openal/**.c*"}
    includedirs {"../include", openal_include}
end

if (WITH_ALSA == 1) then
    defines {"WITH_ALSA"}
    files {"../src/backend/alsa/**.c*"}
    includedirs {"../include"}
end
...
if (WITH_MINIAUDIO == 1) then
    ...
    files {"../src/backend/miniaudio/**.c*"}
    includedirs {"../include"}
end

if (WITH_NOSOUND == 1) then
    defines {"WITH_NOSOUND"}
    files {"../src/backend/nosound/**.c*"}
    includedirs {"../include"}
end
...
if (WITH_PORTAUDIO == 1) then
    ...
    files {"../src/backend/portaudio/**.c*"}
    includedirs {"../include", portaudio_include}
end

if (WITH_SDL == 1) then
    defines {"WITH_SDL"}
    files {"../src/backend/sdl/**.c*"}
    includedirs {"../include", sdl2_include}
end
...
if (WITH_SDL_STATIC == 1) then
    ...
    files {"../src/backend/sdl_static/**.c*"}
    includedirs {"../include", sdl_include}
end

if (WITH_SDL2_STATIC == 1) then
    defines {"WITH_SDL2_STATIC"}
    files {"../src/backend/sdl2_static/**.c*"}
    includedirs {"../include", sdl2_include}
end

if (WITH_WASAPI == 1) then
    defines {"WITH_WASAPI"}
    files {"../src/backend/wasapi/**.c*"}
    includedirs {"../include"}
end

if (WITH_XAUDIO2 == 1) then
    defines {"WITH_XAUDIO2"}
    files {"../src/backend/xaudio2/**.c*"}
    includedirs {"../include", dxsdk_include}
end
...
if (WITH_VITA_HOMEBREW == 1) then
    ...
    files {"../src/backend/vita_homebrew/**.c*"}
    includedirs {"../include"}
end
...
if (WITH_JACK == 1) then
    defines {"WITH_JACK"}
    links {"jack"}
    files {"../src/backend/jack/**.c*"}
    includedirs {"../include"}
end

if (WITH_NULL == 1) then
    defines {"WITH_NULL"}
    files {"../src/backend/null/**.c*"}
    includedirs {"../include"}
end
